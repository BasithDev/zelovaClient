...
export const getCategoriesToMng = (params = {})=>api.get('/admin/manage/categories', { params })
export const getSubCategoriesToMng = (params = {})=>api.get('/admin/manage/subcategories', { params })
...
export const fetchUsers = (params = {}) => api.get('/admin/manage/users', { params })
export const fetchVendors = (params = {}) => api.get('/admin/manage/vendors', { params })
export const blockUnblockUser = (userId, status) => api.patch(`/admin/manage/block-unblock-user/${userId}`, status)
export const blockUnblockVendor = (vendorId, status) => api.patch(`/admin/manage/block-unblock-vendor/${vendorId}`, status)
...
export const sendEmailOtp = (data) => api.post('/user/send-otp', data)
export const updateUserEmail = (data) => api.patch('/user/update-email', data)
